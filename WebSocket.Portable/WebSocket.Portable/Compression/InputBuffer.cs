...
namespace WebSocket.Portable.Compression
{
    ...
    internal class InputBuffer
    {
        ...
        {
            get { return (_end - _start) + (AvailableBits / 8); }
        }
        ...
        public bool EnsureBitsAvailable(int count)
        {
            ...
            _bitBuffer |= (uint)_buffer[_start++] << this.AvailableBits;
        ...
        public int CopyTo(byte[] output, int offset, int length)
        {
            ...
            Debug.Assert((this.AvailableBits % 8) == 0, "");
        ...
        {
            var boundary = this.AvailableBits % 8;
            _bitBuffer >>= boundary;
            this.AvailableBits -= boundary;
        }
    }
}
